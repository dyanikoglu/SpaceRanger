...
public:
	...
	Material(type t) {
		...
		case Material::gold:
			...
			break;
		case Material::bright_white:
			light_ambient = vec4(1, 1, 1, 1.0);
			light_diffuse = vec4(1.0, 1.0, 1.0, 1.0);
			light_specular = vec4(1.0, 1.0, 1.0, 1.0);
			material_ambient = vec4(1, 1, 1, 1.0);
			material_diffuse = vec4(1, 1, 1, 1.0);
			material_specular = vec4(1, 1, 1, 1.0);
			material_shininess = 1000;
			break;
		case Material::bright_green:
			light_ambient = vec4(1, 1, 1, 1.0);
			light_diffuse = vec4(1.0, 1.0, 1.0, 1.0);
			light_specular = vec4(1.0, 1.0, 1.0, 1.0);
			material_ambient = vec4(0, 1, 0, 1.0);
			material_diffuse = vec4(0, 1, 0, 1.0);
			material_specular = vec4(0, 1, 0, 1.0);
			material_shininess = 1000;
		}
	}
};